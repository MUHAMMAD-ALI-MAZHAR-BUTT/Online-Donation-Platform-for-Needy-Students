...
VALUES (CURRENT_TIMESTAMP,'fee', '$id', '$a','$b','$c','$d','$e','$f')";
$query1 = "INSERT INTO `notifications` (`name`,`email`, `type`, `message`, `status`, `date`,`type1`) VALUES ('$name'
            , '$email', 'donor','Donor $name has donated $f rupees on the Platform in Fee Category', 'unread', CURRENT_TIMESTAMP,'donation')";
mysqli_query($con, $query1);
$query2 = "UPDATE donators set total_donated=total_donated+$f,fee_donated=fee_donated+$f,no_of_times=no_of_times+1 where id='$id'";
mysqli_query($con, $query2);
$query3 = "UPDATE balance set total_in_fee=total_in_fee+$f,available_in_fee=available_in_fee+$f where id=1";

           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a   href="Something.html"><i class="fa fa-qrcode fa-3x"></i>Total Donation</a>
                    </li>
                    <li>
                        ...
                        -->
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <li>
                                        <a href="study.html">Study Expenses</a>
                                    </li>
           ...
           <li>
            ...
            <li>
                  ...
                  <li  >
                    ...
                    <li>
                        <a  href="ui.html"  class="active-menu" ><i class="fa fa-desktop fa-3x"></i> Feedback</a>
                    </li>
                </ul>
...
<!-- Modal -->
<h4>Your Feedback is successfully submitted to Admin.We are thankful to you for this kind of act.</h4>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<p  id="abcd" style="font-size:98px; text-align: center; ">&#128151;</p>
<br><br><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<br>
<!--
<div style="width:30%;height:0;"><iframe src="https://giphy.com/embed/21HtXqCprrU7Xsr0qo"position:relative; width="30%" height="50%"  style="position:absolute" frameBorder="0" class="giphy-embed" ></iframe></div>

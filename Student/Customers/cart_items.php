...
$mysqli = new mysqli("127.0.0.1","root","","test");
   $stmts= $mysqli->query("SELECT order_quantity,order_name FROM orderdetails where order_id =$delete_id");
...
//$update_quantity="update recycledproducts set prod_quantity=prod_quantity+$q, prod_sold=prod_sold-$q WHERE prod_name='". $name. "'";
$mysqli->query("update recycledproducts set prod_quantity=prod_quantity+$q, prod_sold=prod_sold-$q WHERE prod_name='". $name. "'");
 $mysqli -> close();

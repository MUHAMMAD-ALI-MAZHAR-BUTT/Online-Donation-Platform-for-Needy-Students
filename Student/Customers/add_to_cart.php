...
if (isset($_GET['cart']) && !empty($_GET['cart'])) {
    $id = $_GET['cart'];
    $stmt_edit = $DB_con->prepare('SELECT * FROM recycledproducts WHERE prod_id =:prod_id');
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <form role="form" method="post" action="save_order.php">
                ...
                <td><input class="form-control" type="hidden" name="order_name" value="<?php echo $prod_name; ?>" /></td>
                <td><input class="form-control" type="hidden" name="order_price" value="<?php echo $prod_price; ?>" /></td>
                ...
                <table class="table table-bordered table-responsive">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" type="text" name="v1" value="<?php echo $prod_name; ?>" disabled /></td>
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" type="text" name="v2" value="<?php echo $prod_price; ?>" disabled /></td>
                    </tr>
                    <tr>
                        <td><label class="control-label">Available Quantity.</label></td>
                        <td><input class="form-control" type="text" name="v2" value="<?php echo $prod_quantity; ?>" disabled /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><label class="control-label">Quantity you want to buy.</label></td>
                    ...
                    <tr>
                        <td colspan="2"><button href="cart_items.php?quantity=10" type="submit" name="order_save" class="btn btn-primary">

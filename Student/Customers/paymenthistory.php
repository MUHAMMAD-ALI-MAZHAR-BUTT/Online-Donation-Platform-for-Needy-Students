...
<body>
  ...
  background-image: linear-gradient(315deg, #6e72fc 0%, #ad1deb 74%);">
                    ...
                    <li class="active"><a href="paymenthistory.php"> &nbsp; <span class='fa fa-money'></span> Payment received history</a></li>
        ...
        <div id="page-wrapper">
            ...
            <div class="alert alert-success">
                ...
                <center>
                    <h3><strong>My payment history </strong> </h3>
                </center>
                    ...
                    student on payment_history.student_id=student.id where date_comp IS NOT NULL and payment_history.student_id='$id' order by payment_history.date_comp desc  ");
                            ...
                            <div class="col-xs-12">
                                <div class="alert alert-warning">
                                    <span class="glyphicon glyphicon-info-sign"></span> &nbsp; Payment record is empty so far...
                                </div>
                            </div>
                        <?php
                        }

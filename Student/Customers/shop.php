	...
	<div id="wrapper">
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php">Waste Management System </a>
			</div>
		...
		<div id="page-wrapper">
			...
			<div class="alert alert-default" style="color:white;background-color:#008CBA">
				<center>
					<h3> <span class="glyphicon glyphicon-shopping-cart"></span> These are our Products!!!</h3>
				</center>
			</div>
			...
			$query = mysqli_query($conn, "select * from recycledproducts LIMIT $start, $limit");
            ...
            <center> 
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>" . $query2['prod_name'] . "</textarea>
			</center>
            </div>
            <div class='panel-body'>
           <a class='fancybox-buttons' href='../Admin/item_images/" . $query2['item_image'] . "' data-fancybox-group='button' title='Page " . $id . "- " . $query2['prod_name'] . "'>
					
					<img src='../Admin/item_images/" . $query2['item_image'] . "' class='img img-thumbnail'  style='width:350px;height:150px;' />
					</a>
				
					
					<center><h4> Price:&#8360; " . $query2['prod_price'] . " </h4></center>
					<center><h4> Available Quantity: " . $query2['prod_quantity'] . " </h4></center>
					
										<a class='btn btn-block btn-danger' href='add_to_cart.php?cart=" . $query2['prod_id'] . "'><span class='glyphicon glyphicon-shopping-cart'></span> Add to cart</a>
            </div>
          </div>
        </div>";
			}
			...
			$rows = mysqli_num_rows(mysqli_query($conn, "select * from recycledproducts"));

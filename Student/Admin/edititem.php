...
if (isset($_POST['btn_save_updates'])) {
	...
	if (!isset($errMSG)) {
		$stmt = $DB_con->prepare('UPDATE recycledproducts
									     SET  
			...
			<form method="post" enctype="multipart/form-data" class="form-horizontal">
				...
				<table class="table table-bordered table-responsive">
					...
					<tr>
						...
						<td><input class="form-control" type="text" name="prod_quantity" value="<?php echo $prod_quantity; ?>" required /></td>
					</tr>
					...
					<tr>
						...
						<td><input id="inputprice" class="form-control" type="text" name="prod_price" value="<?php echo $prod_price; ?>" required /></td>
					</tr>
					...
					<form enctype="multipart/form-data" method="post" action="additems.php">
						<fieldset>
							...
							<div class="form-group">
								...
								<input class="form-control" placeholder="Quantity Sold" name="prod_sold" type="text" required>
							...
							<div class="form-group">
								...
								<input class="form-control" placeholder="Item ID" name="item_ID" type="text" required>

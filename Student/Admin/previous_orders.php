                ...
                <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            echo "<tr>";
                            echo "<td colspan='4' align='center' style='font-size:18px;'>" ."Customer Name: <span style='color:red;'>" . $user_firstname . " " . $user_lastname . "</span> | " . "Address: <span style='color:red;'>" . $user_address . " </span>";
                            echo "</td>";

...
<head>
  ...
  <link href="dist/assets/css/flexslider.css" rel="stylesheet" />
...
<body>
  ...
  <!--   
   <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO THE Waste Management System <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
  ...
  <!--
           <div class="row" >
               ...
               <a class="btn btn-info btn-set"  >SLS 2016 Zain</a>
                </div>
                   </div>
                 ...
                 <hr />
				   ...
				   <br />
               <a class="btn btn-info btn-set"  >Legendary Ceo</a>
                </div>
                   </div>
               ...
               <a class="btn btn-info btn-set"  >2015 SLS Women Division Champion</a>
                 ...
                 <hr />
				   ...
				   <br />
				   <br />
               <a class="btn btn-info btn-set"  >SLS 2013 Champion</a>
                </div>
                   </div>
  ...
  <!--
    ...
    <div class="container set-pad">
             <div class="row text-center">
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line">Site Developer</h1>
                     <p data-scroll-reveal="enter from the bottom after 0.3s">
